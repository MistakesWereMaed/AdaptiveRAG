"""
Build ES (Elasticsearch) BM25 Index. --- Adapted from "build_index.py" from the IRCoT codebase https://github.com/StonyBrookNLP/ircot
"""
...
def make_hotpotqa_documents(elasticsearch_index: str, metadata: Dict = None):
    raw_glob_filepath = os.path.join("../data/corpus", "hotpotqa", "wikpedia-paragraphs", "*", "wiki_*.bz2")
...
def make_iirc_documents(elasticsearch_index: str, metadata: Dict = None):
    raw_filepath = os.path.join("../data/corpus", "iirc", "context_articles.json")
...
def make_2wikimultihopqa_documents(elasticsearch_index: str, metadata: Dict = None):
    raw_filepaths = [
        os.path.join("../data/corpus", "2wikimultihopqa", "train.json"),
        os.path.join("../data/corpus", "2wikimultihopqa", "dev.json"),
        os.path.join("../data/corpus", "2wikimultihopqa", "test.json"),
    ]
    metadata = metadata or {"idx": 1}
    assert "idx" in metadata
...
def make_musique_documents(elasticsearch_index: str, metadata: Dict = None):
    raw_filepaths = [
        os.path.join("../data/corpus", "musique", "musique_ans_v1.0_dev.jsonl"),
        os.path.join("../data/corpus", "musique", "musique_ans_v1.0_test.jsonl"),
        os.path.join("../data/corpus", "musique", "musique_ans_v1.0_train.jsonl"),
        os.path.join("../data/corpus", "musique", "musique_full_v1.0_dev.jsonl"),
        os.path.join("../data/corpus", "musique", "musique_full_v1.0_test.jsonl"),
        os.path.join("../data/corpus", "musique", "musique_full_v1.0_train.jsonl"),
    ]
    metadata = metadata or {"idx": 1}
    assert "idx" in metadata
...
def make_wiki_documents(elasticsearch_index: str, metadata: Dict = None):
    raw_glob_filepath = os.path.join("../data/corpus", "wiki", 'psgs_w100.tsv')
    metadata = metadata or {"idx": 1}
    assert "idx" in metadata
